...
for(User u:list)
{
	...
	{out.println("<p><b><i>Name</i></b> : "+u.getName()+"</p>");
	out.println("<p><b><i>Designation</i></b> : "+u.getDesig()+"</p>");
	out.println("<p><b><i>Mobile</i></b> : "+u.getMobile()+"</p>");
	out.println("<p><b><i>Mail</i></b> : "+u.getMail()+"</p>");
	}
}
out.println("</div>");
%>
